      ...
      <div className="grid gap-10 lg:grid-cols-[1.15fr_1fr] lg:items-center">
        <Reveal>
          <div className="flex flex-col gap-6">
            <div className="inline-flex w-fit items-center gap-2 rounded-full border border-amber-400/40 bg-white px-4 py-2 text-[11px] tracking-[0.22em] text-amber-700">
            ...
            <div className="flex flex-wrap gap-3 text-sm text-zinc-700">
              <div className="rounded-xl border border-amber-300/40 bg-white px-4 py-3 shadow-sm">
                <div className="font-display text-lg text-amber-700">+ 800</div>
                <div className="text-xs text-zinc-600">cerimônias</div>
              </div>
              <div className="rounded-xl border border-amber-300/40 bg-white px-4 py-3 shadow-sm">
                <div className="font-display text-lg text-amber-700">Campinas</div>
                <div className="text-xs text-zinc-600">SP e região</div>
              </div>
              <div className="rounded-xl border border-amber-300/40 bg-white px-4 py-3 shadow-sm">
                <div className="font-display text-lg text-amber-700">Luxo</div>
                <div className="text-xs text-zinc-600">alto padrão</div>
              </div>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href="#servicos"
                className="inline-flex h-12 items-center justify-center rounded-xl border border-amber-400/40 bg-white px-6 text-zinc-800 transition hover:scale-[1.02] hover:border-amber-500/70 hover:bg-amber-50"
              >
                Nossos serviços
              </a>
            </div>
        ...
        <Reveal delayMs={120}>
          <div className="relative overflow-hidden rounded-3xl border border-amber-300/40 bg-zinc-100 shadow-[0_25px_90px_rgba(0,0,0,0.16)]">
            <ParallaxImage
